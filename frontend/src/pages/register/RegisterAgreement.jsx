  ...
  return (
    <Wrapper>
      <p>
        ...
        (c) For purposes hereof, “Base Price” shall mean, with respect to the price of any Service, an amount that is the actual cost of such Service (reasonably estimated, to the extent required) without any element of profit or other comparable compensation, which shall include (i) one-time costs and cash and non-cash charges incurred by the provider of such Service, (ii) out-of-pocket costs and expenses incurred subject to



        3

        Section 4 hereof by the provider of such Service, (iii) the cost of any consents, approvals, licenses or other agreements required to be obtained in order for any Service to be provided; (iv) the hourly rate (based on a fully loaded rate that includes all costs of employment, including salary, bonus, benefits, expenses and overhead costs associated with such employment, including office space and payroll costs, but excluding the cost of equity or equity based compensation unless the Parties mutually agree otherwise) for each of the individuals providing Services under this Agreement; and (iv) pass through or allocation of payments made to any party in connection with providing the Company Services or the HCP Services.
        ...
        (d) Each Party shall provide to the other an invoice (each, an “Initial Invoice”) reflecting the Base Price, as applicable, for any services (and any related costs and expenses) provided to, or for the benefit



        5

        of, of the other party during the period beginning on October 1, 2011 and ending on the date of this Agreement. Each Initial Invoice shall be in such reasonable detail as to identify the services provided and by whom, the amounts charged therefor and any incurred out-of-pocket expenses. Upon written request, each Party shall provide the other with copies of invoices from any third parties for such out-of-pocket expenses. The Initial Invoices of the Company and HCP shall be netted and the remainder shall be paid within thirty (30) days thereafter or such other period of time as the Parties shall agree to in writing.
        ...
        17. NOTICES. All written notices, demands and other communications given to or made by either Party to the other in connection with this Agreement shall be either personally served on an officer or other authorized representative of the Party to which it is given or mailed by registered first class mail, postage prepaid, to the headquarters of such Party to the attention of its chief financial officer, with a copy to its general counsel, or to such other address and to the attention of such persons as the Party in question may from time to time specify to the other by notice hereunder. All notices shall be deemed delivered and effective (a) if hand-delivered, upon delivery, or (b) if mailed, three (3) business days after mailing.
        ...
        19. FURTHER ASSURANCES. Each of the Parties shall execute such documents and perform such further acts as may be reasonably required or desirable to carry out or to perform the provisions of this Agreement.
